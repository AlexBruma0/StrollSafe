...
public class CaregiverActivity extends AppCompatActivity {
    ...
    public void loginButton(){
        loginBtn = (Button) findViewById(R.id.PWDLogin1);
        editE = (EditText) findViewById(R.id.editPWDEmail);
        editP = (EditText) findViewById(R.id.editPWDPassword);
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               login(email,password);
                startActivity(new Intent(CaregiverActivity.this, ListOfPWDActivity.class));
            }
        });
    }
